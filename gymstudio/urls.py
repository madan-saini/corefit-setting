...
urlpatterns = [
     ...
     #****Schedule Page
     path('set-your-availability', scheduleView.setAvailability, name='set-your-availability'),
...
#Accreditation
     ...
     path('deletelocation', fformSubmit.deleteLocation),

     path('requests', fformSubmit.employeeRequests),
     path('viewInviteRequest', fformSubmit.viewInviteRequest),
     path('changeInviteRequestStatus', fformSubmit.changeInviteRequestStatus),
     path('searchInviteRequest', fformSubmit.searchInviteRequest),
     path('disassociation', fformSubmit.disassociation),
     path('cancelAssociation', fformSubmit.cancelAssociation),
...
#      identifications
     ...
     #****Wallet Module Page     
     path('bank-and-cards', walletController.bankcards,name='bank-and-cards'),
     path('bankSubmit', walletController.bankSubmit),
     path('cardSubmit', walletController.cardSubmit),
     path('mybolt-ons', walletController.mybolt,name='mybolt-ons'),
     path('bolt-ons', walletController.boltlist,name='bolt-ons'),
     path('updateBoltStatus', walletController.updateBoltStatus),
     path('enquireSubmit', walletController.enquireSubmit),
     path('payment', walletController.payment,name='payment'),
     path('available-subscription-plans', walletController.subscriptionPlans,name='available-subscription-plans'),
     path('my-plan', walletController.myPlan,name='my-plan'),
     path('getPlanData', walletController.getPlanData),

     #*****Request Module Page*****
     path('employee-requests', requestController.employeeRequest,name='employee-requests'),
     path('viewRequest', requestController.viewRequest),
     path('changeRequestStatus', requestController.changeRequestStatus),
     path('searchRequest', requestController.searchRequest),
     path('invite-employee', requestController.inviteEmployee,name='invite-employee'),
     path('add-personal-trainer', requestController.addPersonalTrainer,name='add-personal-trainer'),
     path('searchTrainer', requestController.searchTrainer),
     path('addTrainer', requestController.addTrainer),
     path('viewSPInviteRequest', requestController.viewInviteRequest),
     path('searchSPRequest', requestController.searchSPRequest),
     path('cancelRequestStatus', requestController.cancelRequestStatus),
